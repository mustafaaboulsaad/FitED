...
def make_custom_peak_model(profile_def, prefix):
    ...
    def _custom_peak(x, **kwargs):
        return evaluate_custom_expression(expression, x, kwargs)

    return Model(_custom_peak, independent_vars=["x"], param_names=param_names, prefix=prefix)
