...
APP_VERSION = "v1.0"
SOFTWARE_DOI = "10.5281/zenodo.19411621"
Citation = "Aboulsaad, M. M. FitED. Zenodo. https://doi.org/10.5281/zenodo.19411621"
...
class DesktopPLFitterApp:
    ...
    def _draw_peak_rows(self, row_states):
        ...
        for i, state in enumerate(row_states):
            ...
            custom_combo.pack(side='left', padx=(0, 14))

            ttk.Label(row0, text='G/L').pack(side='left', padx=(0, 4))
            ttk.Entry(row0, textvariable=frac_var, width=10).pack(side='left', padx=(0, 14))
            ...
            ttk.Entry(row1, textvariable=cmax_var, width=10).pack(side='left', padx=(0, 0))
            ...
            ttk.Entry(row2, textvariable=amax_var, width=10).pack(side='left', padx=(0, 0))
    ...
    def reset_peaks_and_fit_state(self):
        ...
        self.status_var.set('Peaks, picked centers, ROI, and fit state reset for current spectrum.')
    ...
    def refine_with_added_peaks(self):
        ...
        try:
            ...
            self.status_var.set(f'Refine with added peaks complete. Chi-square: {final_result.chisqr:.6g}')
    ...
    def autofill_from_centers(self):
        ...
        try:
            ...
            self.status_var.set(f'Automatic pre-fit complete. Best chi-square: {best_result.chisqr:.6g}')
    ...
    def _plot_loaded_data(self):
        ...
        self.ax_resid.clear()
        self._refresh_hover_axis()
        self.ax_main.plot(self.x_full, self.y_full, 'k-', linewidth=1.1)
    ...
    def run_fit(self):
        ...
        self.fig.tight_layout()
        self.canvas.draw_idle()
        self.status_var.set(f'Fit complete. Chi-square: {result.chisqr:.6g}')
